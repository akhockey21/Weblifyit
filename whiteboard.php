...
PagesManage::update(Auth::user()->id, 1, 'test', 1);
PagesContent::update(Auth::user()->id, 1, 'test', 1);
Media::update(Auth::user()->id, 'test', 1);
WebsiteSettings::update(Auth::user()->id, 'test', 1);
BusinessInfo::update(Auth::user()->id, 'test', 1);
GlobalThemes::update('test', 2);
GlobalCategories::update('test', 2);
GlobalShortcodes::update('test', 2);
