...
//Add all of models if not there.
...
<div id="page-content">
        ...
        <div class="header-section">
            <div class="row">
                ...
                <div class="col-md-4 col-lg-6 hidden-xs hidden-sm">
                    <h1>Welcome <strong><?php echo Auth::user()->display_name; ?></strong><br><small>You Look Awesome!</small></h1>
                </div>
                <!-- END Main Title -->
    ...
    <div class="content-header">
        <ul class="nav-horizontal text-center">
            ...
            <li>
                <a href="javascript:void(0)"><i class="gi gi-charts"></i> Leads</a>
            </li>
            <li>
                <a href="javascript:void(0)"><i class="gi gi-video_hd"></i> Automation Setup</a>
            </li>
            <li>
                <a href="javascript:void(0)"><i class="gi gi-music"></i>  Add a Store</a>
            </li>
            <li>
                <a href="javascript:void(0)"><i class="fa fa-cubes"></i> Invoices</a>
            </li>
             <li>
                <a href="javascript:void(0)"><i class="gi gi-briefcase"></i> Payment</a>
            </li>
            <li>
