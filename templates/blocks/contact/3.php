                        ...
                        <div class="col_three_fifth col_last">
                            ...
                            <div class="widget notoppadding noborder">
                                ...
                                <div class="fslider testimonial twitter-scroll" data-animation="slide" data-arrows="false">
                                    ...
                                    <div class="flex-viewport" style="overflow: hidden; position: relative; height: 79px;"><div class="slider-wrap" style="width: 1000%; transform: translate3d(-548px, 0px, 0px); transition-duration: 0.6s; -webkit-transition-duration: 0.6s; -webkit-transform: translate3d(-548px, 0px, 0px);"><div class="slide clone" aria-hidden="true" style="float: left; display: block; width: 274px;">
                                            ...
                                            <div class="slide" style="float: left; display: block; width: 274px;">
                                                <div class="testi-image">
                                                    <a href="#"><i class="icon-twitter2"></i></a>
                                                </div>
                                                <div class="testi-content">
                                            ...
                                            <div class="slide flex-active-slide" style="float: left; display: block; width: 274px;">
                                                <div class="testi-image">
                                                    <a href="#"><i class="icon-twitter2"></i></a>
                                                </div>
                                                <div class="testi-content">
                                        ...
                                        <div class="slide clone" aria-hidden="true" style="float: left; display: block; width: 274px;">
                                                <div class="testi-image">
                                                    <a href="#"><i class="icon-twitter2"></i></a>
                                                </div>
                                                <div class="testi-content">
